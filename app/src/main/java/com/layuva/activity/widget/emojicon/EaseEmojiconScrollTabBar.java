package com.layuva.activity.widget.emojicon;
...
import com.layuva.R;
import com.layuva.activity.utils.ScreenUtils;
...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    public void addTab(int icon){
        ...
        int tabWidth = 60;
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(ScreenUtils.dpToPxInt(context, tabWidth), LayoutParams.MATCH_PARENT);
